...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="../css_ecole/resultatexam.css"/>
...
<section>
    <p> pas de resultat pour le moment </p>
    LA DIRECTION
</section>
<div class="bloc_partenaire">
    <div class="photos_partenaires">
        <h3 class =titre_partenaire style="font-size: 50px; color: white; text-align: center; margin-bottom:30px">nos parténaires</h3>
