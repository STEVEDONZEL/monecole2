...
<section>
    ...
    <div class="container">
        <div class="mySlides">
            ...
            <img src="../image/ctn5.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">2 / 6</div>
            <img src="../image/ct5.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">3 / 6</div>
            <img src="../image/ctn8.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">4 / 6</div>
            <img src="../image/cantine13.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">5 / 6</div>
            <img src="../image/quan.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">6 / 6</div>
            <img src="../image/ga.jpg" style="width:45%">
        </div>
        <div class="mySlides">
            <div class="numbertext">1 / 6</div>
            <img src="../image/cho.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">2 / 6</div>
            <img src="../image/via.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">3 / 6</div>
            <img src="../image/com.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">4 / 6</div>
            <img src="../image/sa.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">5 / 6</div>
            <img src="../image/gou.jpg" style="width:45%">
        </div>

        <div class="mySlides">
            <div class="numbertext">6 / 6</div>
            <img src="../image/elc.jpg" style="width:45%">
        </div>
