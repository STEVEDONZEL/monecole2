...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="../css_ecole/dossiersins.css"/>
...
<section>
  <p> Dossier d'inscription</br></p>
   <p>ecole primaire felix moumie - 12 juillet 2018</br></p>
   <p> Pièces à fournir pour l'inscription</br></p>
    <ol>
        <li> la  copie d'acte de naissance certifié de l'enfant</li>
        <li>les deux derniers bulletins de note de la classe précédente</li>
        <li> 4 photos 4*4</li>
        <li> Certificat de santé + Relevé des vaccinations (BCG-DT polio) + Dossier médical</li>
        <li>frais d'inscription (50000 frc)</li>
    </ol>
</section>
