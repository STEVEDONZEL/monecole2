...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" href="../css_ecole/admission.css"/>
    ...
    <ul>
        <li>
            ...
            <ul>
                ...
                <li><a href="../html_ecole/reglementint.php">règlement financier </a></li>
                <li><a href="../html_ecole/presentation.php">test d'entré </a></li>
            </ul>
        </li>
    </ul>
